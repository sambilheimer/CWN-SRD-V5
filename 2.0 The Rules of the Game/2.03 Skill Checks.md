...
nav_order: 3
permalink: /rules-of-the-game/skill-checks/
---
...
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 6          | A relatively simple task that is still more<br>than the PC would usually be expected<br>to manage in their regular background.<br>Anything easier than this isn't worth a<br>skill check. |
| 8          | A significant challenge to a competent<br>professional that they'd still succeed at<br>more often than not.                                                                               |
| 10         | Something too difficult to be expected<br>of anyone but a skilled expert, and even<br>they might fail.                                                                                    |
| 12         | Only a true master could expect to carry<br>this off with any degree of reliability.                                                                                                      |
| 14+        | Only a true master has any chance of<br>achieving this at all, and even they will<br>probably fail.                                                                                       |
